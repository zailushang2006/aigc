...
|名称| 简介 | github      |官网| 更新      | star |
|:-----:|:----------|:---------|:----|:--------|:-----|
|langchain|Building applications with LLMs through composability|https://github.com/langchain-ai/langchain| https://python.langchain.com/docs/get_started/introduction.html | 2023-08 | 57.8k |
|llama_index|LlamaIndex (GPT Index) is a data framework for your LLM application.|https://github.com/jerryjliu/llama_index| https://gpt-index.readthedocs.io/en/stable/                     | 2023-08 | 19.9k |
|dify|One API for plugins and datasets, one interface for prompt engineering and visual operation, all for creating powerful AI applications.|https://github.com/langgenius/dify| https://dify.ai/                                                | 2023-08 | 6.8k  |
|langflow|Langflow is a UI for LangChain|https://github.com/logspace-ai/langflow| http://www.logspace.ai/    | 2023-08 | 11.3k |
|awesome-langchain|Awesome list of tools and projects with the awesome LangChain framework|https://github.com/kyrolabs/awesome-langchain|   无   | 2023-07 | 4.4k  |


## 和CV的结合
|名称| 简介 | github      |官网| 更新      | star |
|:-----:|:----------|:---------|:----|:--------|:-----|
|MiniGPT-4|Enhancing Vision-language Understanding with Advanced Large Language Models|https://github.com/Vision-CAIR/MiniGPT-4|   无   | 2023-04 | 22k  |
...
|名称| 简介 | github      |官网| 更新      | star |
|:-----:|:----------|:---------|:----|:--------|:-----|
|AudioGPT|Understanding and Generating Speech, Music, Sound, and Talking Head|https://github.com/AIGC-Audio/AudioGPT|   无   | 2023-04 | 9k  |


## 训练微调
|名称| 简介  | github      | 官网                                           | 更新      | star |
|:-----:|:----------|:---------|:---------------------------------------------|:--------|:-----|
|FastChat|An open platform for training, serving, and evaluating large language models.|https://github.com/lm-sys/FastChat| 无 | 2023-08 | 26k   |
|DeepSpeed|DeepSpeed is a deep learning optimization library that makes distributed training and inference easy, efficient, and effective.|https://github.com/microsoft/DeepSpeed| https://www.deepspeed.ai/ | 2023-07 | 27.5k |
|DeepSpeed-Chat|DeepSpeed is a deep learning optimization library that makes distributed training and inference easy, efficient, and effective.|https://github.com/microsoft/DeepSpeed/tree/master/blogs/deepspeed-chat|   无   |  2023-07 | 27.5k   |
|peft|PEFT: State-of-the-art Parameter-Efficient Fine-Tuning.|https://github.com/huggingface/peft| https://huggingface.co/docs/peft/index       | 2023-07 | 8.7k  |
|lora|Using Low-rank adaptation to quickly fine-tune diffusion models.|https://github.com/cloneofsimo/lora|   无   | 2023-02 | 5.4k  |
|qlora|QLoRA: Efficient Finetuning of Quantized LLMs|https://github.com/artidoro/qlora|   无   | 2023-07 | 7.1k  |
|P-tuning-v2|An optimized deep prompt tuning strategy comparable to fine-tuning across scales and tasks|https://github.com/THUDM/P-tuning-v2|   无   | 2023-01 | 1.5k  |
|LMFlow|An Extensible Toolkit for Finetuning and Inference of Large Foundation Models. Large Models for All.|https://github.com/OptimalScale/LMFlow| https://optimalscale.github.io/LMFlow/       | 2023-08 | 7.1k  |
|alpaca-lora|Instruct-tune LLaMA on consumer hardware|https://github.com/tloen/alpaca-lora|   无   | 2023-04 | 16.6k |
|accelerate|A simple way to train and use PyTorch models with multi-GPU, TPU, mixed-precision|https://github.com/huggingface/accelerate| https://huggingface.co/docs/accelerate/index | 2023-08 | 5.4k  |
